...
\begin{table}[H]
    ...
    \begin{tabular}{|l|r|r|}
        ...
        Salidas Anuales & 704 & Personas que se van \\
        Costo Anual Rotación & \$2.112.000 & USD 3.000/persona \\
        \midrule
        Antigüedad Promedio & 3.24 años & Distribución exponencial \\
        Desempeño Promedio & 3.18/5.0 & Escala 1-5 \\
        Clima Promedio & 3.21/5.0 & Ambiente laboral \\
        Compromiso Promedio & 3.08/5.0 & Factor crítico \\
        Ausentismo Promedio & 7.89 días/año & Indicador de estrés \\
        \bottomrule
    \end{tabular}
\end{table}
...
\textbf{Conclusión EDA:} El compromiso emerge como factor dominante en decisión de rotación, sugiriendo que intervenciones deben enfocarse en mejorar conexión emocional del empleado con la organización.
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|r|r|r|}
        ...
        \midrule
        \textbf{TOTAL} & \textbf{3.200} & \textbf{22.0\%} & \textbf{704} \\
        \bottomrule
    \end{tabular}
\end{table}

\textbf{Hallazgo Crítico:} La rotación en áreas críticas es 3.6 veces mayor que en otras áreas, representando el riesgo operacional más significativo.
...
\textbf{Patrón:} Rotación más alta en primeros 2 años (período crítico), luego estabilización. Inversión inicial en retención del 1-2 año tiene impacto significativo.
...
\textbf{Hallazgo:} Personas con bajo desempeño rotan más (32.2\%), sugiriendo presión en sistema. Excelente desempeño no retiene (14.7\%), indicando falta de oportunidades.
