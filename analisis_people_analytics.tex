...
\begin{center}
    ...
    {\small\textit{Modelo Random Forest — ROC-AUC: 65.9\%}}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|r|r|r|r|}
        ...
        \midrule
        Regresión Logística & 78.1\% & 0.677 & 1.0\% & 100.0\% \\
        Random Forest & 78.0\% & 0.659 & 0.0\% & 100.0\% \\
        \bottomrule
    \end{tabular}
\end{table}

\textbf{Modelo Seleccionado:} Random Forest (ROC-AUC 0.659). Regresión Logística obtiene AUC ligeramente superior (0.677).
...
\begin{enumerate}
    ...
    \item \textbf{Modelo Predictivo:} AUC 0.659 (RF) y 0.677 (Regresión Logística) permiten segmentación y priorización de intervenciones sobre el 32.7\% en zona de riesgo alto.
